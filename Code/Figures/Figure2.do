...
global path "/Users/ScottDaewonKim/DropBox/Research/Old/petra_moser/MoS baby boom/Replication"
...
// 	reg patent_1000 _Iage* i.year i.cluster, r
	reghdfe patent_1000 _Iage*, absorb(year cluster)
...
// global axis1 xlabel(20 25 30 35 40 45 50 55 60 65, nogrid) ylabel(-50(50)200, angle(0) nogrid) xline(27)
global axis1 xlabel(20 25 30 35 40 45 50 55 60 65, nogrid) ylabel(-20(20)100, angle(0) nogrid) xline(27)
...
// graph export "$path//Output/Figures/Figure2.png", as(png) replace
