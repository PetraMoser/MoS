...
// 	reg paper_100 _Iage* i.year i.cluster_vols_13, r
	reghdfe paper_100 _Iage*, absorb(unique_id year)
...
global axis1 xlabel(20(5)65, nogrid) ylabel(-5(5)25, angle(0) nogrid) xline(27)
...
graph export "$path//Output/Figures/Figure5.png", as(png) replace
